...
EXTDEF : TYPE EXTVARS SEMI { $$ = new VarExtDef($2); }
	| STSPEC SEXTVARS SEMI { $$ = new StExtDef($1, $2); }
...
EXTVAR : VAR		{ $$ = new ExtVar($1); }
	...
	;
STSPEC : STRUCT ID LC SDEFS RC { $$ = new StSpec(*$2, $4); }
	| STRUCT LC SDEFS RC { $$ = new StSpec($3); }
	| STRUCT ID { $$ = new StSpec(*$2); }
	;
...
SDEF : TYPE SDECS SEMI	{ $$ = new StDef($2); }
	;
...
EXPS : LP EXPS RP	{ $$ = $2; }
	| ID LP ARGS RP	{ $$ = new CallExp(*$1, $3); }
	| ID ARRS		{ $$ = new ArrsExp(*$1, $2); }
	| ID DOT ID		{ $$ = new AccessExp(*$1, *$3); }
	| INT		{ $$ = new IntExp($1);}
	| EXPS ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS ADD_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS SUB_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS MUL_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS DIV_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS AND_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS XOR_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS OR_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS SHL_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS SHR_ASSIGN EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS L_OR EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS L_AND EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS B_OR EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS B_XOR EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS B_AND EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS EQ EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS NEQ EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS GT EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS GTE EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS LT EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS LTE EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS SHL EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS SHR EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS ADD EXPS	 { $$ = new BopExp(*$2, $1, $3); }
		// binary minus
	| EXPS SUB EXPS 	{ $$ = new BopExp(*$2, $1, $3); }
	| EXPS MUL EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS DIV EXPS	 { $$ = new BopExp(*$2, $1, $3); }
	| EXPS MOD EXPS	 { $$ = new BopExp(*$2, $1, $3); }
		// unary minus
	| SUB   EXPS	%prec UMINUS 		{ $$ = new UopExp(*$1, $2); }
	| L_NOT EXPS	 { $$ = new UopExp(*$1, $2); }
	| P_ADD EXPS	 { $$ = new UopExp(*$1, $2); }
	| P_SUB EXPS	 { $$ = new UopExp(*$1, $2); }
	| B_NOT EXPS	 { $$ = new UopExp(*$1, $2); }
	;
